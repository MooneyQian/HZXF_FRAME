...
layui.define(["jquery", "qian", "html", "Add"], function (exports) {
    ...
    function _EquipmentInfo_Add() {
        _this = this;
    };

    //页面初始化
    _EquipmentInfo_Add.prototype.init = function () {
        Add.init();
    }
    ...
    var EquipmentInfo_Add = new _EquipmentInfo_Add();
    exports('EquipmentInfoAdd', EquipmentInfo_Add);
});